...
""")
    ...
    st.markdown(f"""
        <img src="data:image/jpeg;base64,{encoded_image}" width="700" height="500">
    """, unsafe_allow_html=True)
    st.markdown("***Proposed Rehabilitation Site***")

    # --- Image 2 ---
    Pro2 = "images/IMG-20250703-WA0049.jpg"
    ...
    with open(Pro3, "rb") as image_file:
        encoded_image = base64.b64encode(image_file.read()).decode()
    st.markdown(f"""
        <img src="data:image/jpeg;base64,{encoded_image}" width="700" height="400">
    """, unsafe_allow_html=True)
    ...
    with open(Pro4, "rb") as image_file:
        encoded_image = base64.b64encode(image_file.read()).decode()
    st.markdown(f"""
        <img src="data:image/jpeg;base64,{encoded_image}" width="600" height="800">
    """, unsafe_allow_html=True)
    ...
    with open(Pro6, "rb") as image_file:
        encoded_image = base64.b64encode(image_file.read()).decode()
    st.markdown(f"""
        <img src="data:image/jpeg;base64,{encoded_image}" width="600" height="500">
    """, unsafe_allow_html=True)
    st.markdown("***Landuse Analysis chart***")

    # --- Image 7 ---
    Pro7 = "images/plot analysis table.png"
    with open(Pro7, "rb") as image_file:
        encoded_image = base64.b64encode(image_file.read()).decode()
    st.markdown(f"""
        <img src="data:image/jpeg;base64,{encoded_image}" width="700" height="450">
    """, unsafe_allow_html=True)
    ...
    with open(Pro8, "rb") as image_file:
        encoded_image = base64.b64encode(image_file.read()).decode()
    st.markdown(f"""
        <img src="data:image/jpeg;base64,{encoded_image}" width="600" height="550">
    """, unsafe_allow_html=True)
